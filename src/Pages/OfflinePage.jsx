  ...
  return (
    <div className="w-full  flex flex-col items-center justify-center">
      ...
      <div className='w-full px-14 '>
        Hey INTERNET , im Aryan btw you can call me <b className="text-accent twitter_text">Aaron</b> if my name is hard to pronounce ,
