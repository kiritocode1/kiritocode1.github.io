  ...
  <div class="w-[10rem] mask mask-hexagon ">
    <img src={Picture} alt="profile" />
      ...
      <div className="w-full mb-2 flex items-center justify-center ">
        ...
        <TypeAnimation
    sequence={['Full Stack Developer', 3000, '19', 3000, 'Loves All Types Of Music', 3000, 'Gamer', 3000, 'Weab', 3000,'Hikiomori', 4000, '@kiritocode1', 13000, 'Occassionally gets Laid', 5000, 'L from Deathnote', 4000, 'Open Source', 4000, 'Loves Mushrooms', 3000, 'Coffee to Code Converter', 5000, 'Student in NBN, Pune', 1000, '190 wpm ', 1000, 'Black Lives Matter', 3000]}
